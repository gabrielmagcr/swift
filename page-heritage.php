...
$swiftImg = "/wp-content/themes/swift/assets/img/heritage/Redesign-2024/OurStory/SWIFT.svg"
?>
    ...
    <div class="container container-heritage">
        ...
        <div class="h-h-biography">
            <div class="h-h-biography-left">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/OurStory/Frame-214.webp" alt="Gustavus Swift">
            </div>
            <div class="h-h-biography-right">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/OurStory/Old-Swift.webp" alt="Old Swift">
                <p>
        ...
        <div class="h-h-biography-end">
            <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/OurStory/pointer-1.webp" alt="Pointer SwiftMeats">
...
<section class="dates-badge">
    <div class="dates hideScrollbar">
        <div class="date date-active"><a href="#1855"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1855</span></a></div>
        <div class="date"><a href="#1861"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1861</span></a></div>
        <div class="date"><a href="#1862"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1862</span></a></div>
        <div class="date"><a href="#1872"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1872</span></a></div>
        <div class="date"><a href="#1875"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1875</span></a></div>
        <div class="date"><a href="#1878"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1878</span></a></div>
        <div class="date"><a href="#1880"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1880</span></a></div>
        <div class="date"><a href="#1893"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1893</span></a></div>
        <div class="date"><a href="#1900"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1900</span></a></div>
        <div class="date"><a href="#1903"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1903</span></a></div>
        <div class="date"><a href="#1915"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1915</span></a></div>
        <div class="date"><a href="#1924"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1924</span></a></div>
        <div class="date"><a href="#1943"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1943</span></a></div>
        <div class="date"><a href="#1964"><img src="<?php echo $swiftImg ?>" alt="SwiftLogo"><span>1964</span></a></div>
    </div>
</section>
<section class="year-1855 year-badge">
    <div class="container container-1855">
        <div class="years" id="1855"><span class="year">1855</span></div>
        <div class="h-text">
        ...
        <div class="h-images">
            <div class="dollar-1885"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1855/20.png" alt="20$ 1855"></div>
            <div class="first-store-1885"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1855/Frame216.png" alt="Swift Meats First Store"></div>
        </div>
    </div>
    <div class="empty-div"></div>
    <div class="cow-1885 container">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1855/cow.png" alt="Cow SwiftMeats">
    </div>
...
<section class="year-1861-1862 year-badge">
    <div class="container">
        <div class="container-1861">
            <div class="h-images">
                <div class="years" id="1861"><span class="year">1861</span></div>
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1861-1862/1861.png" alt="1861 SwiftMeats">
        ...
        <div class="container-1862">
            <div class="left-1862">
                <div class="years" id='1862'><span class="year">1862</span></div>
            ...
            <div class="right-1862 h-images">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1861-1862/1862.png" alt="SwiftMeats Massachusetts">
            </div>
        </div>
    </div>
    <div  class="empty-div"></div>
...
<section class="year-1872 year-badge">
    <div class="container">
        <div class="container-1872">
            <div class="left-1872">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1872-1875/Handshake.png" alt="HandShake SwiftMeats">
            </div>
            <div class="right-1872">
                <div class="years" id='1872'><span class="year">1872</span></div>
                <div class="h-text">
        ...
        <div class="container-1875">
            <div class="left-1875">
                <div class="years" id='1875'><span class="year">1875</span></div>
                <div class="h-text">
            ...
            <div class="right-1875">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1872-1875/1875.png" alt="SwiftMeats 1875">
            </div>
        </div>
        <div  class="empty-div"></div>
    </div>
...
<section class="year-1878 year-badge">
    <div class="ribbon">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1878/Ribbon.png" alt="Swift Meats Ribbon">
    </div>
    <div class="container container-1878">
        <div class="left-1878">
            <div class="years" id='1878'><span class="year">1878</span></div>
            <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1878/swiftmeats-newspaper.png" alt="Swiftmeats Newspaper">
        </div>
    ...
    <div class="train">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1878/train-1.png" alt="SwiftMeats Train">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1878/train-2.png" alt="SwiftMeats Train" class="yellowTrain">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1878/train-3.png" alt="SwiftMeats Train">
        <div  class="empty-div"></div>
    </div>
</section>
<section class="year-1880 year-badge">
    <div class="container-1880">
        <div class="container">
            <div class="years" id="1880"><span class="year">1880</span></div>
            <div class="h-text">
            ...
            <div class="h-images">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1880/1880.webp" alt="SwiftMeats Refrigerator Line">
            </div>
        </div>
        <div  class="empty-div"></div>
    </div>
...
<section class="year-1893 year-badge">
    <div class="container container-1893">
        <div class="left-1893 h-images">
            <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1893/1893.png" alt="Northwestern University SwiftMeats">
        </div>
        <div class="right-1893">
            <div class="years" id='1893'><span class="year">1893</span></div>
            <div class="h-text">
...
<section class="year-1900 year-badge">
    <div class="container container-1900">
        <div class="left-1900 ">
            <div class="years" id='1900'><span class="year">1900</span></div>
            <div class="h-images">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1900/1900.png" alt="SwiftMeats Boat 1900">
            </div>
...
<section class="year-1903 year-badge">
    <div class="container container-1903">
        <div class="left-1903" >
            <div class="h-images"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1903/1903.jpg" alt=""></div>
        </div>
...
<section class="year-1915 year-badge">
    <div class="container container-1915">
        <div class="left-1915">
            <div class="years"  id='1915'><span class="year">1915</span></div>
            <div class="h-text">
        ...
        <div class="right-1915 h-images">
            <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1915/1915-1.png" alt="Safety First SwiftMeats-1"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1915/1915-2.png" alt="Safety First SwiftMeats-2">
        </div>
    </div>
    <div class="empty-div"></div>
</section>
<section class="year-1924 year-badge">
    <div class="container container-1924">
        <div class="left-1924 h-images">
            <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1924/1924-1.png" alt="SwiftMeats on the Brithish Empire"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1924/1924-2.png" alt="SwiftMeats on the Brithish Empire">
        </div>
        <div class="right-1924">
            <div class="years"  id='1924'><span class="year">1924</span></div>
            <div class="h-text">
...
<section class="year-1943 year-badge">
    <div class="news-1943 hideScrollbar">
        <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1943/1943-news.png" alt="SwiftMeat WW2">
    </div>
    <div class="container container-1943">
        <div class="left-1943">
            <div class="h-images">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1943/1943.jpg" alt="SwiftMeats in the war">
            </div>

            <div class="years" id='1943'><span class="year">1943</span></div>
        </div>
...
<section class="year-1964 year-badge">
    <div class="container container-1964">
        <div class="left-1964">
            <div class="years" id='1964'><span class="year">1964</span></div>
            <div class="h-text">
        ...
        <div class="right-1964">
            <div class="h-images">
                <img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1964/1964-1.png" alt="SwiftMeats HotDog premium"><img src="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/1964/1964-2.png" alt="SwiftMeats HotDog">
            </div>
        </div>
    </div>
</section>
<section id="today" class="year-today">
    ...
    <div class="container container-today">
        ...
        <div class="right-today" >
            <video poster="/wp-content/themes/swift/assets/img/heritage/Redesign-2024/today/today-poster.webp" controls>
